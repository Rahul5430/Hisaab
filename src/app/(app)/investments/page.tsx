...
export default function InvestmentsPage() {
	...
	const [selectedInvestment, setSelectedInvestment] =
		useState<InvestmentSchema | null>(null);
		...
		<div className='px-4 py-6 space-y-6'>
			...
			<div className='bg-background border border-[--color-border] rounded-xl p-6 space-y-4'>
				...
				{Object.entries(breakdownByType).length > 0 && (
					<div className='flex flex-wrap gap-2'>
						{Object.entries(breakdownByType).map(
							([type, amount]) => (
								<div
									key={type}
			...
			{selectedInvestment && (
				<div className='fixed inset-0 z-50 flex items-end justify-center'>
					...
					/>
					<div className='relative bg-background rounded-t-2xl max-w-107.5 w-full max-h-[90vh] overflow-y-auto'>
