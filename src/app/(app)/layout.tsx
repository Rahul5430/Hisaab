...
function AppShellSkeleton({ pathname }: { pathname: string }) {
	if (pathname === '/onboarding') {
		return (
	...
	return (
		<div className='min-h-dvh bg-(--color-background)'>
			<div className='relative mx-auto flex min-h-dvh w-full max-w-[430px] flex-col bg-background'>
				...
				<div className='pointer-events-none absolute inset-x-0 bottom-0 flex justify-center pb-[calc(env(safe-area-inset-bottom)+72px)]'>
